...
class Department(models.Model):
    ...
    managers = models.ManyToManyField(Employee, verbose_name="Management Staff", blank=True)
...
class Division(models.Model):
    ...
    managers = models.ManyToManyField(Employee, verbose_name="Managers", blank=True)
